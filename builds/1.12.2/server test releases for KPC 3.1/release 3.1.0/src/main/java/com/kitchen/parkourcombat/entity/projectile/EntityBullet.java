package com.kitchen.parkourcombat.entity.projectile;
...
public class EntityBullet extends Entity implements IProjectile
{
    ...
    public EntityBullet(World worldIn, ItemStack s, EntityLivingBase shooter)
    {
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            if (entity.attackEntityFrom(damagesource, (float)i))
            {
                ...
                this.playSound(SoundEvents.ENTITY_GENERIC_SMALL_FALL, 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
        ...
        else
        {
            ...
            if (iblockstate.getMaterial() != Material.AIR)
            {
            	// hook for destroying materials of low hardness
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        if (!this.world.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.pickupStatus == EntityBullet.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getAmmoStack()))
            {
                flag = false;
            }
    ...
    // hook for setting bullet damage
     ...
     */
    // hook for setting knockback strength
    public void setKnockbackStrength(float bulletForce)
    {
        this.knockbackStrength = bulletForce;
    }
