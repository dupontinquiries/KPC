package media.kitchen.kitchenparkour.crafting.newstuff;
...
public class KWorkBenchCont extends RecipeBookContainer<CraftingInventory> {
    private final CraftingInventory craftMatrix = new CraftingInventory(this, 3, 3);
    private final CraftResultInventory craftResult = new CraftResultInventory();
    private final IWorldPosCallable field_217070_e;
    private final PlayerEntity player;

    public KWorkBenchCont(int p_i50089_1_, PlayerInventory p_i50089_2_) {
        this(p_i50089_1_, p_i50089_2_, IWorldPosCallable.DUMMY);
    }

    public KWorkBenchCont(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_) {
