...
import media.kitchen.kitchenparkour.crafting.IKRecipeType;
...
public class KPCContainer extends CustomRecipeBookContainer<CraftingInventory> {
    ...
    public KPCContainer(int winId, PlayerInventory playerInventory, IWorldPosCallable worldPos) {
        super(ContainerType.CRAFTING /* Parkour.KPC_CRAFTING_CONTAINER.get() */, winId); // TODO: implement the KPC_CRAFTING_CONTAINER dialog
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.worldPos.consume((world, blockPos) -> {
            ...
            //world.playSound(null, new BlockPos(blockPos.getX(), blockPos.getY(), blockPos.getZ()), Parkour.PARKOUR_GRIPPER_READY.get(), SoundCategory.AMBIENT, 0.5F, 1F );
        });
    }
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 0) {
                ...
                playerIn.world.playSound(null, playerIn.getPosition(), Parkour.KPC_TABLE_CRAFT.get(), SoundCategory.AMBIENT, 1.4F, 1F );
            }
        }
    ...
    @OnlyIn(Dist.CLIENT)
    public CustomRecipeBookCategory func_241850_m() {
        return CustomRecipeBookCategory.KPC_CRAFTING;
    }
