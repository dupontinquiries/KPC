...
public class CustomServerRecipePlacer<C extends IInventory> implements IRecipePlacer<Integer> {
    protected static final Logger LOGGER = LogManager.getLogger();
    protected final RecipeItemHelper recipeItemHelper = new RecipeItemHelper();
    protected PlayerInventory playerInventory;
    protected CustomRecipeBookContainer<C> recipeBookContainer;

    public CustomServerRecipePlacer(CustomRecipeBookContainer<C> recipeBookContainer) {
    ...
    protected void clear() {
        for(int i = 0; i < this.recipeBookContainer.getWidth() * this.recipeBookContainer.getHeight() + 1; ++i) {
            if (i != this.recipeBookContainer.getOutputSlot() || !(this.recipeBookContainer instanceof KPCContainer)) { ////// changed
                this.giveToPlayer(i);
            }
        }
