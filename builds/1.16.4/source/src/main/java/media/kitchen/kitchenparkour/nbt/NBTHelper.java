package media.kitchen.kitchenparkour.nbt;
...
public class NBTHelper {
        ...
        public static CompoundNBT toNBT(Object o) {
            ...
            if(o instanceof ChargableTile) {
                return writeChargableTile((ChargableTile)o);
            }

            return null;
        }

        private static CompoundNBT writeChargableTile(ChargableTile o) {
            CompoundNBT compound = new CompoundNBT();
            compound.putInt("x", o.getX());
            compound.putInt("y", o.getY());
            compound.putInt("z", o.getZ());
            compound.putInt("lmin", o.getLMax());
            compound.putInt("lmax", o.getLMin());
            compound.putInt("counter", o.getCounter());
            return compound;
        }
