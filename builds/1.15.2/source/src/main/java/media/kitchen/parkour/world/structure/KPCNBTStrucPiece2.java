...
public class KPCNBTStrucPiece2 {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        protected boolean spawnBoss(IWorld worldIn, MutableBoundingBox p_175817_2_, int i, int j, int k, Random rand) {
                ...
                if ( !worldIn.isRemote() ) {
                    for (int g = 0; g < 3; ++g) {
                        // create a boss
                        EvokerEntity boss = EntityType.EVOKER.create(worldIn.getWorld());
                        ...
                        // give it a crown
                        boss.replaceItemInInventory(100 + EquipmentSlotType.HEAD.getIndex(), new ItemStack(Parkour.TAYDON_HELM.get()));
                        // armor it up
                        boss.replaceItemInInventory(100 + EquipmentSlotType.CHEST.getIndex(), new ItemStack(Parkour.TAYDON_CHEST.get()));
                        // give it a weapon
