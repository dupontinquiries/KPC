...
public class ForgeStructure extends Structure<NoFeatureConfig> {
    private static final List<Biome.SpawnListEntry> ENEMIES = Lists.newArrayList(new Biome.SpawnListEntry(EntityType.DROWNED, 1, 12, 36));

    public ForgeStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> noFeatureConfigIn) {
    ...
    public Structure.IStartFactory getStartFactory() {
        return ForgeStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart {
        ...
        private void generateStart(int chunkX, int chunkZ) {
            ...
            this.components.add(new ForgePiece.MonumentBuilding(this.rand, i, j, direction));
