...
public class KPCForgeBlobPiece2 {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public boolean func_225577_a_(IWorld worldIn, ChunkGenerator<?> chunkGenIn, Random rand, MutableBoundingBox mutableBB, ChunkPos chunkPos) {
            ...
            int i = ( mutableBB.maxX + mutableBB.minX ) / 2,
        ...
        // spawn boss fight
        protected boolean spawnBoss(IWorld worldIn, MutableBoundingBox p_175817_2_, int i, int j, int k) {
            if (p_175817_2_.isVecInside(new BlockPos(i, j, k))) {
                ...
                if ( true ) {
                    for (int g = 0; g < 30; ++g) {
                        ...
                        // give it a crown
                        boss.replaceItemInInventory(100 + EquipmentSlotType.HEAD.getIndex(), new ItemStack(Items.WET_SPONGE));
                        // armor it up
