...
public class FishMeleeGoal extends Goal {
    ...
    public FishMeleeGoal(CreatureEntity creature, double speedIn, boolean useLongMemory) {
    ...
    public boolean shouldExecute() {
        ...
        if (i - this.field_220720_k < 20L) {
            ...
            if (this.attacker.getAttackTarget() == null) {
                this.attacker.setAttackTarget(world.getClosestPlayer(this.attacker, 40));
            }
