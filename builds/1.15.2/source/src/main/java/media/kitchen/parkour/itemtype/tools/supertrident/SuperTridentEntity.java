...
public class SuperTridentEntity extends AbstractArrowEntity {
    ...
    private ItemStack thrownStack = new ItemStack(Parkour.SUPER_TRIDENT.get());
    private boolean dealtDamage;
    public int returningTicks, explodeTicks = 0;

    public SuperTridentEntity(EntityType<? extends net.minecraft.entity.projectile.TridentEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public SuperTridentEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
    ...
    @OnlyIn(Dist.CLIENT)
    public SuperTridentEntity(World worldIn, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if ((this.dealtDamage || this.getNoClip()) && entity != null) {
            ...
            if ( !world.isRemote() && this.explodeTicks == 0 ) {
                ++explodeTicks;
