...
public class ForgePiece{
    public static class DoubleXRoom extends ForgePiece.Piece {
        public DoubleXRoom(Direction p_i50661_1_, ForgePiece.RoomDefinition p_i50661_2_) {
        ...
        public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.EAST.getIndex()];
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;
    ...
    /*
    public static class CraftingRoom extends ForgePiece.Piece {
        public CraftingRoom(Direction direc, ForgePiece.RoomDefinition def) {
            super(IStructurePieceType.OMDXYR, 1, direc, def, 2,2, 1);
        }
    }
    */

    public static class DrownedSpawnerRoom extends ForgePiece.Piece {
        public DrownedSpawnerRoom(Direction p_i50659_1_, ForgePiece.RoomDefinition p_i50659_2_) {
            super(IStructurePieceType.OMDXYR, 1, p_i50659_1_, p_i50659_2_, 2, 2, 1);
        }

        public DrownedSpawnerRoom(TemplateManager p_i50660_1_, CompoundNBT p_i50660_2_) {
        ...
        public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.EAST.getIndex()];
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition2 = oceanmonumentpieces$roomdefinition1.connections[Direction.UP.getIndex()];
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition3 = oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()];
            if (this.roomDefinition.index / 25 > 0) {
                this.generateDefaultFloor(p_225577_1_, p_225577_4_, 8, 0, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.getIndex()]);
                this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.getIndex()]);
            }
            ...
            for(int i = 1; i <= 7; ++i) {
                BlockState blockstate = DIAMOND_BLOCK;
                if (i == 2 || i == 6) {
                    blockstate = WATER;
                }
            ...
            BlockState solidBlock = DIAMOND_BLOCK, lightBlock = SEA_LANTERN;
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 2, 1, 3, 2, 7, 4, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 3, 1, 2, 4, 7, 2, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 3, 1, 5, 4, 7, 5, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 13, 1, 3, 13, 7, 4, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 11, 1, 2, 12, 7, 2, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 11, 1, 5, 12, 7, 5, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, 1, 3, 5, 3, 4, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 10, 1, 3, 10, 3, 4, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, 7, 2, 10, 7, 5, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, 5, 2, 5, 7, 2, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 10, 5, 2, 10, 7, 2, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, 5, 5, 5, 7, 5, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 10, 5, 5, 10, 7, 5, solidBlock, solidBlock, false);
            this.setBlockState(p_225577_1_, solidBlock, 6, 6, 2, p_225577_4_);
            this.setBlockState(p_225577_1_, solidBlock, 9, 6, 2, p_225577_4_);
            this.setBlockState(p_225577_1_, solidBlock, 6, 6, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, solidBlock, 9, 6, 5, p_225577_4_);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, 4, 3, 6, 4, 4, solidBlock, solidBlock, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 9, 4, 3, 10, 4, 4, solidBlock, solidBlock, false);
            this.setBlockState(p_225577_1_, lightBlock, 5, 4, 2, p_225577_4_);
            this.setBlockState(p_225577_1_, lightBlock, 5, 4, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, lightBlock, 10, 4, 2, p_225577_4_);
            this.setBlockState(p_225577_1_, lightBlock, 10, 4, 5, p_225577_4_);
            if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.SOUTH.getIndex()]) {
                this.makeOpening(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 2, 0);
            }
    ...
    public static class DoubleXYRoom extends ForgePiece.Piece {
        public DoubleXYRoom(Direction p_i50659_1_, ForgePiece.RoomDefinition p_i50659_2_) {
            super(IStructurePieceType.OMDXYR, 1, p_i50659_1_, p_i50659_2_, 2, 2, 1);
        }
    ...
    public static class DoubleYRoom extends ForgePiece.Piece {
        public DoubleYRoom(Direction p_i50657_1_, ForgePiece.RoomDefinition p_i50657_2_) {
        ...
        public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
            ...
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.UP.getIndex()];
            if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()] == null) {
    ...
    public static class DoubleYZRoom extends ForgePiece.Piece {
        public DoubleYZRoom(Direction p_i50655_1_, ForgePiece.RoomDefinition p_i50655_2_) {
        ...
        public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.NORTH.getIndex()];
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition2 = oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()];
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition3 = oceanmonumentpieces$roomdefinition1.connections[Direction.UP.getIndex()];
            if (this.roomDefinition.index / 25 > 0) {
    ...
    public static class DoubleZRoom extends ForgePiece.Piece {
        public DoubleZRoom(Direction p_i50653_1_, ForgePiece.RoomDefinition p_i50653_2_) {
    ...
    public static class EntryRoom extends ForgePiece.Piece {
        public EntryRoom(Direction p_i45592_1_, ForgePiece.RoomDefinition p_i45592_2_) {
    ...
    static class FitSimpleRoomHelper implements ForgePiece.IMonumentRoomFitHelper {
        private FitSimpleRoomHelper() {
        }

        public boolean fits(ForgePiece.RoomDefinition definition) {
            return true;
        }

        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            p_175968_2_.claimed = true;
            return new ForgePiece.SimpleRoom(p_175968_1_, p_175968_2_, p_175968_3_);
        }
    }

    static class FitSimpleRoomTopHelper implements ForgePiece.IMonumentRoomFitHelper {
        ...
        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            p_175968_2_.claimed = true;
            return new ForgePiece.SimpleTopRoom(p_175968_1_, p_175968_2_);
        }
    }

    interface IMonumentRoomFitHelper {
        boolean fits(ForgePiece.RoomDefinition definition);

        ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_);
    }

    public static class MonumentBuilding extends ForgePiece.Piece {
        private ForgePiece.RoomDefinition sourceRoom;
        private ForgePiece.RoomDefinition coreRoom;
        private final List<ForgePiece.Piece> childPieces = Lists.newArrayList();
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, Direction p_i45599_4_) {
            ...
            List<ForgePiece.RoomDefinition> list = this.generateRoomGraph(p_i45599_1_);
            this.sourceRoom.claimed = true;
            this.childPieces.add(new ForgePiece.EntryRoom(direction, this.sourceRoom));
            this.childPieces.add(new ForgePiece.MonumentCoreRoom(direction, this.coreRoom));
            List<ForgePiece.IMonumentRoomFitHelper> list1 = Lists.newArrayList();

            /*
            list1.add(new ForgePiece.XYDoubleRoomFitHelper());
            list1.add(new ForgePiece.YZDoubleRoomFitHelper());
            list1.add(new ForgePiece.ZDoubleRoomFitHelper());
            list1.add(new ForgePiece.XDoubleRoomFitHelper());
            list1.add(new ForgePiece.YDoubleRoomFitHelper());
            list1.add(new ForgePiece.FitSimpleRoomTopHelper());
            list1.add(new ForgePiece.FitSimpleRoomHelper());
            */

            label47:
            for(ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition : list) {
                if (!oceanmonumentpieces$roomdefinition.claimed && !oceanmonumentpieces$roomdefinition.isSpecial()) {
                    ...
                    ForgePiece.IMonumentRoomFitHelper oceanmonumentpieces$imonumentroomfithelper;
                    while(true) {
                        if (!lvt_10_1_.hasNext()) {
                            continue label47;
                        }

                        oceanmonumentpieces$imonumentroomfithelper = (ForgePiece.IMonumentRoomFitHelper)lvt_10_1_.next();
            ...
            for(ForgePiece.Piece oceanmonumentpieces$piece : this.childPieces) {
            ...
            //this.childPieces.add(new ForgePiece.WingRoom(direction, mutableboundingbox1, i++));
            //this.childPieces.add(new ForgePiece.WingRoom(direction, mutableboundingbox2, i++));
            this.childPieces.add(new ForgePiece.Penthouse(direction, mutableboundingbox));
        }
        ...
        private List<ForgePiece.RoomDefinition> generateRoomGraph(Random p_175836_1_) {
            ForgePiece.RoomDefinition[] aoceanmonumentpieces$roomdefinition = new ForgePiece.RoomDefinition[75];

            for(int i = 0; i < 5; ++i) {
                for(int j = 0; j < 4; ++j) {
                    int k = 0;
                    int l = getRoomIndex(i, 0, j);
                    aoceanmonumentpieces$roomdefinition[l] = new ForgePiece.RoomDefinition(l);
                }
            }
            ...
            for(int i2 = 0; i2 < 5; ++i2) {
                for(int l2 = 0; l2 < 4; ++l2) {
                    ...
                    aoceanmonumentpieces$roomdefinition[j4] = new ForgePiece.RoomDefinition(j4);
                }
            }
            ...
            for(int j2 = 1; j2 < 4; ++j2) {
                for(int i3 = 0; i3 < 2; ++i3) {
                    ...
                    aoceanmonumentpieces$roomdefinition[k4] = new ForgePiece.RoomDefinition(k4);
                }
            }
            ...
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = new ForgePiece.RoomDefinition(1003);
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition1 = new ForgePiece.RoomDefinition(1001);
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition2 = new ForgePiece.RoomDefinition(1002);
            ...
            List<ForgePiece.RoomDefinition> list = Lists.newArrayList();

            for(ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition4 : aoceanmonumentpieces$roomdefinition) {
            ...
            for(ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition3 : list) {
                int j5 = 0;
                int k5 = 0;
    ...
    public static class MonumentCoreRoom extends ForgePiece.Piece {
        public MonumentCoreRoom(Direction p_i50663_1_, ForgePiece.RoomDefinition p_i50663_2_) {
    ...
    public static class Penthouse extends ForgePiece.Piece {
        ...
        public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
            ...
            this.spawnBoss(p_225577_1_, p_225577_4_, 6, 1, 6);
            return true;
        }
    }

    public abstract static class Piece extends StructurePiece {
        protected static final BlockState ROUGH_PRISMARINE = Blocks.BLUE_STAINED_GLASS.getDefaultState();
        protected static final BlockState BRICKS_PRISMARINE = Blocks.BLUE_STAINED_GLASS.getDefaultState();
        protected static final BlockState DIAMOND_BLOCK = Blocks.DIAMOND_BLOCK.getDefaultState();
        protected static final BlockState DARK_PRISMARINE = Blocks.BLUE_STAINED_GLASS.getDefaultState();
        ...
        protected ForgePiece.RoomDefinition roomDefinition;
        ...
        protected Piece(IStructurePieceType p_i50649_1_, int p_i50649_2_, Direction p_i50649_3_, ForgePiece.RoomDefinition p_i50649_4_, int p_i50649_5_, int p_i50649_6_, int p_i50649_7_) {
        ...
        // spawn boss fight
        protected boolean spawnBoss(IWorld worldIn, MutableBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
            ...
            if (p_175817_2_.isVecInside(new BlockPos(i, j, k))) {
                ...
                if ( true ) {
                    for (int g = 0; g < 10; ++g) {
                        ...
                        //SuperTridentGoal superTridentGoal = new SuperTridentGoal(boss,
                        //        1.0D, 30, 15.0F);

                        //boss.goalSelector.addGoal(2, superTridentGoal);
                        //boss.goalSelector.addGoal(1, superTridentGoal);
                        //boss.goalSelector.addGoal(3, superTridentGoal);
                        //boss.goalSelector.addGoal(4, superTridentGoal);

                        //boss.goalSelector.addGoal(2, superTridentGoal);


                        //boss.targetSelector.addGoal(2, new NearestAttackableTargetGoal<GuardianEntity>(boss,
                        //        GuardianEntity.class, 10, true, false, ));
                        ...
                        boss.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(boss.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue() * 1.8F);

                        // give it a crown
                        boss.replaceItemInInventory(100 + EquipmentSlotType.HEAD.getIndex(), new ItemStack(Items.BLUE_STAINED_GLASS));
                        // give it a weapon
                        ...
                        boss.setLocationAndAngles((double)i + 0.5D, (double)j, (double)k + 0.5D, 0.0F, 0.0F);
                    ...
                    for (int g = 0; g < 60; ++g) {
                        // create a boss
                        SalmonEntity boss = EntityType.SALMON.create(worldIn.getWorld());

                        FishMeleeGoal attackGoal = new FishMeleeGoal(boss, 1D, true);

                        boss.goalSelector.addGoal(0, attackGoal);

                        // buff its attributes
                        //boss.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(8F);
                        boss.getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(12F);

                        boss.getAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(5F);

                        boss.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(1.6F);
    ...
    static class RoomDefinition {
        ...
        private final ForgePiece.RoomDefinition[] connections = new ForgePiece.RoomDefinition[6];
        ...
        public void setConnection(Direction p_175957_1_, ForgePiece.RoomDefinition p_175957_2_) {
    ...
    public static class SimpleRoom extends ForgePiece.Piece {
        private int mainDesign;

        public SimpleRoom(Direction p_i45587_1_, ForgePiece.RoomDefinition p_i45587_2_, Random p_i45587_3_) {
    ...
    public static class SimpleTopRoom extends ForgePiece.Piece {
        public SimpleTopRoom(Direction p_i50644_1_, ForgePiece.RoomDefinition p_i50644_2_) {
    ...
    public static class WingRoom extends ForgePiece.Piece {
        private int mainDesign;
        ...
        public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
            if (this.mainDesign == 0) {
                ...
                this.spawnBoss(p_225577_1_, p_225577_4_, 11, 2, 16);
            } else if (this.mainDesign == 1) {
                ...
                this.spawnBoss(p_225577_1_, p_225577_4_, 11, 5, 13);
            }
    ...
    static class XDoubleRoomFitHelper implements ForgePiece.IMonumentRoomFitHelper {
        ...
        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            ...
            return new ForgePiece.DoubleXRoom(p_175968_1_, p_175968_2_);
        }
    }

    static class XYDoubleRoomFitHelper implements ForgePiece.IMonumentRoomFitHelper {
        ...
        public boolean fits(ForgePiece.RoomDefinition definition) {
            if (definition.hasOpening[Direction.EAST.getIndex()] && !definition.connections[Direction.EAST.getIndex()].claimed && definition.hasOpening[Direction.UP.getIndex()] && !definition.connections[Direction.UP.getIndex()].claimed) {
                ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = definition.connections[Direction.EAST.getIndex()];
        ...
        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            ...
            return new DrownedSpawnerRoom(p_175968_1_, p_175968_2_);
        }
    }

    static class YDoubleRoomFitHelper implements ForgePiece.IMonumentRoomFitHelper {
        ...
        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            p_175968_2_.claimed = true;
            p_175968_2_.connections[Direction.UP.getIndex()].claimed = true;
            return new ForgePiece.DoubleYRoom(p_175968_1_, p_175968_2_);
        }
    }

    static class YZDoubleRoomFitHelper implements ForgePiece.IMonumentRoomFitHelper {
        ...
        public boolean fits(ForgePiece.RoomDefinition definition) {
            if (definition.hasOpening[Direction.NORTH.getIndex()] && !definition.connections[Direction.NORTH.getIndex()].claimed && definition.hasOpening[Direction.UP.getIndex()] && !definition.connections[Direction.UP.getIndex()].claimed) {
                ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = definition.connections[Direction.NORTH.getIndex()];
                return oceanmonumentpieces$roomdefinition.hasOpening[Direction.UP.getIndex()] && !oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()].claimed;
            } else {
                return false;
            }
        ...
        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            ...
            return new ForgePiece.DoubleYZRoom(p_175968_1_, p_175968_2_);
        }
    }

    static class ZDoubleRoomFitHelper implements ForgePiece.IMonumentRoomFitHelper {
        ...
        public ForgePiece.Piece create(Direction p_175968_1_, ForgePiece.RoomDefinition p_175968_2_, Random p_175968_3_) {
            ForgePiece.RoomDefinition oceanmonumentpieces$roomdefinition = p_175968_2_;
            ...
            return new ForgePiece.DoubleZRoom(p_175968_1_, oceanmonumentpieces$roomdefinition);
        }
    }
}