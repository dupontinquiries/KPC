...
public class EntityEnergyBeam extends Entity
{
    ...
    public EntityEnergyBeam(final World w, final EntityLivingBase source, final EntityLivingBase target,
		...
		this.posY = source.posY + source.getEyeHeight() - kVal;
    ...
    public EntityEnergyBeam(final World w, final EntityLivingBase elb, final float p_i1756_3_, final Item Ammo) {
		super(w);
		this.field_145791_d = -1;
		this.field_145792_e = -1;
		this.field_145789_f = -1;
