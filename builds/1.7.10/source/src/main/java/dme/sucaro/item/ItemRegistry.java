...
public final class ItemRegistry {
	...
	//public static DamageSource Arc = new DamageSource("arc").func_76348_h().func_76359_i().func_76351_m();
	
	//guns
	
	
	public static Item MGMk1 = new ItemGun(2, 1.0, 0.012, 1.5, 3.0f, 1, 0, 0, Items.blaze_powder, "smoke", false, false, 0.0).setTextureName("sucaro:MG1").setUnlocalizedName("MG Mk. 1");
	public static Item MGMk2 = new ItemGun(7, 2.0, 0.009, 0.5, 3.0f, 1, 1, 0, Items.blaze_powder, "smoke", false, false, 0.0).setTextureName("sucaro:MG2").setUnlocalizedName("MG Mk. 2");
	public static Item MGMk3 = new ItemGun(1, .5, 0.005, 1.0, 3.0f, 1, 1, 0, Items.blaze_powder, "smoke", false, false, 0.0).setTextureName("sucaro:MG3").setUnlocalizedName("MG Mk. 3");
	public static Item MGMk4 = new ItemGun(30, .5, 0.015, 0.3, 5.0f, 1, 1, 0, Items.blaze_powder, "smoke", false, false, 0.0).setTextureName("sucaro:MG4").setUnlocalizedName("MG Mk. 4");
	public static Item SGMk1 = new ItemGun(6, 1.0, 0.1, 1.0, 2.0f, 1, 6, 0, Items.blaze_powder, "fireworksSpark", false, false, 0.0).setTextureName("sucaro:SG1").setUnlocalizedName("SG Mk. 1");
	public static Item SGMk2 = new ItemGun(13, 1.0, 0.1, 1.3, 2.0f, 1, 12, 0, Items.blaze_powder, "fireworksSpark", false, false, 0.0).setTextureName("sucaro:SG1").setUnlocalizedName("SG Mk. 2");
	//public static Item MGMk2 = new ItemGun(7, 30.0, 0.0, 2.0, 5.0f, 1, 4, 0, null, "portal", true, false, 1.7).setTextureName("sucaro:MG2").setUnlocalizedName("MGmk2");
	public static Item SMGmk3 = new ItemGun(1, 4.0, 0.01, 0.3, 4.0f, 1, 1, 100, null, "cloud", false, false, 0.1).setTextureName("sucaro:SMG3").setUnlocalizedName("SMGmk3");
    public static Item RLmk1 = new ItemGun(80, 700.0, 0.03, 1.0, 6.0f, 6, 1, 0, null, "portal", true, false, 10.0).setTextureName("sucaro:RL1").setUnlocalizedName("RLmk1");
    public static Item RLmk2 = new ItemGun(40, 5000.0, 0.03, 0.4, 6.0f, 3, 2, 0, null, "flame", true, true, 5.0).setTextureName("sucaro:RL2").setUnlocalizedName("RLmk2");
    public static Item SRMk1 = new ItemGun(40, 40.0, 0.6, 0.0, 10.0f, 3, 1, 0, Items.arrow, "enchantmenttable", false, false, 0.0).setTextureName("sucaro:SR1").setUnlocalizedName("SRmk1");
    public static Item SRMk2 = new ItemGun(15, 15.0, 0.23, 0.04, 7.0f, 1, 1, 0, Items.arrow, "flame", true, false, 2.305).setTextureName("sucaro:SR2").setUnlocalizedName("SRmk2");
    
    public static Item FTMk1 = new ItemGun(0, 0.0, 0.0, 1.5, 2.0f, 0, 5, 100, null, "flame", true, true, 4.0).setTextureName("sucaro:FT1").setUnlocalizedName("FTmk1");
	...
	public static final void init() {
		...
		/*
		MGMk1 = new ItemGun(2, 5.0, 0.0, 1.5, 5.0f, 1, 1, 0, Items.blaze_powder, "smoke", false, false, 0.0)
				.setTextureName("sucaro:MG1").setUnlocalizedName("MGmk1");
		MGMk2 = new ItemGun(7, 30.0, 0.0, 2.0, 5.0f, 1, 4, 0, null, "portal", true, false, 1.7).setTextureName("sucaro:MG2")
				.setUnlocalizedName("MGmk2");
		SMGmk3 = new ItemGun(1, 4.0, 0.01, 0.3, 4.0f, 1, 1, 100, null, "cloud", false, false, 0.1)
				.setTextureName("sucaro:SMG3").setUnlocalizedName("SMGmk3");
		RLmk1 = new ItemGun(80, 700.0, 0.03, 1.0, 6.0f, 6, 1, 0, null, "portal", true, false, 10.0)
				.setTextureName("sucaro:RL1").setUnlocalizedName("RLmk1");
		RLmk2 = new ItemGun(40, 5000.0, 0.03, 0.4, 6.0f, 3, 2, 0, null, "flame", true, true, 5.0)
				.setTextureName("sucaro:RL2").setUnlocalizedName("RLmk2");
		SRMk1 = new ItemGun(40, 40.0, 0.6, 0.0, 10.0f, 3, 1, 0, Items.arrow, "enchantmenttable", false, false,
				0.0).setTextureName("sucaro:SR1").setUnlocalizedName("SRmk1");
		SRMk2 = new ItemGun(15, 15.0, 0.23, 0.04, 7.0f, 1, 1, 0, Items.arrow, "flame", true, false, 2.305)
				.setTextureName("sucaro:SR2").setUnlocalizedName("SRmk2");
		SGMk1 = new ItemGun(10, 5.0, 0.1, 1.5, 2.0f, 1, 20, 0, Items.blaze_powder, "fireworksSpark", false, false,
				0.0).setTextureName("sucaro:SG1").setUnlocalizedName("SGmk1");
		FTMk1 = new ItemGun(0, 0.0, 0.0, 1.5, 2.0f, 0, 5, 100, null, "flame", true, true, 4.0).setTextureName("sucaro:FT1")
				.setUnlocalizedName("FTmk1");
		*/
