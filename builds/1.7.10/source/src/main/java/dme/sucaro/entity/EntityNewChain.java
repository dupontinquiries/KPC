...
public class EntityNewChain extends EntityArrow
{
    ...
    public EntityNewChain(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityNewChain(World w, double x, double y, double z)
    {
        super(w);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityNewChain(World w, EntityLivingBase p, EntityLivingBase p2, float fl1, float fl2)
    {
        super(w);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityNewChain(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
        	...
        	for (int g = 0; g < boundingList.size(); g++){
        		...
        		elbf.setVelocity((e.posX-elbf.posX )/3, (e.posY-elbf.posY )/3, (e.posZ-elbf.posZ )/3);
        		}}}
                ...
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    //{
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            {
                                entitylivingbase.setArrowCountInEntity(entitylivingbase.getArrowCountInEntity() + 10);
                            }
