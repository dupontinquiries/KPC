...
public class EntityProximityArrow extends EntityArrow
{
    ...
    public EntityProximityArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityProximityArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityProximityArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityProximityArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        else
        {
             ...
             * 
             * */
            List boundingList = worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(3, 3, 3));
        	for (int g = 0; g < boundingList.size(); g++){
        		...
        		if(elbf != this.shootingEntity){
            		if(elbf instanceof EntityPlayer){
            			elbf.addPotionEffect(new PotionEffect(Potion.blindness.getId(), 400, 20));
            			elbf.addPotionEffect(new PotionEffect(Potion.nightVision.getId(), 400, 20));
            		}
        		elbf.addPotionEffect(new PotionEffect(Potion.wither.getId(), 20, 5));
        		elbf.worldObj.newExplosion(elbf, elbf.posX, elbf.posY + 0.4, elbf.posZ, 1.8f, false, false);
        		}}}
        	//this.setDead();
            /*
             * 
