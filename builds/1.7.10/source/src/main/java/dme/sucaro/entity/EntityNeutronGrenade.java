...
public class EntityNeutronGrenade extends EntityArrow
{
    ...
    public EntityNeutronGrenade(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityNeutronGrenade(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityNeutronGrenade(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityNeutronGrenade(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            if (block == this.field_145790_g && j == this.inData)
            {
                 ...
                 * 
                 */
                List boundingList = worldObj.getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(100, 100, 100));
            	for (int g = 0; g < boundingList.size(); g++){
            		...
            		elbf.addVelocity(((this.posX-elbf.posX )/this.ticksInGround)/10, (((this.posY+1)-elbf.posY )/this.ticksInGround)/10, ((this.posZ-elbf.posZ )/this.ticksInGround)/10);
            		}}}
                /*
                 * 
                 * Vortex
