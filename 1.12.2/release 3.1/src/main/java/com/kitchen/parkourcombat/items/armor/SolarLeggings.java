...
public class SolarLeggings extends SolarBase implements IHasModel {

	public SolarLeggings(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
